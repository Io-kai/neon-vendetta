...
export const CAMPAIGN: StageDef[] = [STAGE_1,
  {id:'vesper',name:'STAGE 2',sub:'VESPER ROW',theme:'club',bossId:'sable',length:2800,music:'mus_stage',
   ...
   items:[{kind:'knife',x:520,y:215},{kind:'ramen',x:1030,y:220},{kind:'bat',x:1450,y:215},{kind:'soda',x:1580,y:225},{kind:'monoedge',x:1900,y:212},{kind:'ramen',x:2160,y:210}]},
  {id:'canal',name:'STAGE 3',sub:'ASH CANAL',theme:'canal',bossId:'cinder',length:3000,music:'mus_stage',
   ...
   items:[{kind:'pipe',x:570,y:218},{kind:'ramen',x:1110,y:220},{kind:'soda',x:1730,y:207},{kind:'katana',x:2000,y:212},{kind:'ramen',x:2350,y:225},{kind:'sledge',x:2650,y:216}]},
  {id:'spire',name:'STAGE 4',sub:'GLASS SPIRE',theme:'spire',bossId:'orison',length:3200,music:'mus_stage',
   ...
   items:[{kind:'pipe',x:570,y:210},{kind:'bat',x:900,y:214},{kind:'ramen',x:1220,y:220},{kind:'baton',x:1600,y:212},{kind:'soda',x:1830,y:220},{kind:'ramen',x:2510,y:210},{kind:'monoedge',x:2900,y:212}]},
];
